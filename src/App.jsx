        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          <div>
            <div className="flex items-center gap-2 mb-4">
              ...
              <span className="text-lg font-bold text-primary-dark dark:text-secondary-light tracking-tight">
                DwellScout
              </span>
            </div>
            <p className="text-sm text-surface-600 dark:text-surface-400 max-w-xs">
              Finding your perfect property match with advanced search and personal service.
            </p>
          </div>
          ...
          <div>
            ...
            <ul className="space-y-2">
              <li><a href="#" className="text-sm text-surface-600 hover:text-primary dark:text-surface-400 dark:hover:text-white">Properties</a></li>
              <li><a href="#" className="text-sm text-surface-600 hover:text-primary dark:text-surface-400 dark:hover:text-white">List Your Property</a></li>
              <li><a href="#" className="text-sm text-surface-600 hover:text-primary dark:text-surface-400 dark:hover:text-white">Find Agents</a></li>
              <li><a href="#" className="text-sm text-surface-600 hover:text-primary dark:text-surface-400 dark:hover:text-white">Resources</a></li>
            </ul>
          </div>
          
          <div>
            <h3 className="font-semibold text-surface-900 dark:text-white mb-4">Contact</h3>
            <ul className="space-y-2">
              <li className="text-sm text-surface-600 dark:text-surface-400 flex items-start gap-2">
                <svg className="w-5 h-5 mt-0.5 text-primary dark:text-secondary-light" fill="none" viewBox="0 0 24 24" stroke="currentColor">
              ...
              <li className="text-sm text-surface-600 dark:text-surface-400 flex items-start gap-2">
                ...
                <span>contact@dwellscout.com</span>
              </li>
            </ul>
          </div>
        </div>
        
        <div className="border-t border-surface-200 dark:border-surface-700 mt-8 pt-6 flex flex-col md:flex-row justify-between items-center">
          <p className="text-xs text-surface-500 dark:text-surface-400">
            © {new Date().getFullYear()} DwellScout. All rights reserved.
          </p>
          
          <div className="flex items-center gap-4 mt-4 md:mt-0">
            <a href="#" className="text-surface-500 hover:text-primary dark:text-surface-400 dark:hover:text-white">
